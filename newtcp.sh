...
if [ "$release" == "centos" ]; then
    ...
    rpm -Uvh https://github.com/cocabox/cocabox/blob/master/nginx-release-centos-7-0.el7.ngx.noarch.rpm
...
EOF
	...
	wget https://github.com/cocabox/cocabox/blob/master/web.zip
    	unzip web.zip
	...
	if test -s /usr/src/trojan-cert/fullchain.cer; then
        cd /usr/src
	#wget https://github.com/cocabox/cocabox/blob/master/trojan-1.13.0-linux-amd64.tar.xz
	wget https://github.com/cocabox/cocabox/blob/master/trojan-1.14.0-linux-amd64.tar.xz
	tar xf trojan-1.*
	#下载trojan客户端
	wget https://github.com/cocabox/cocabox/blob/master/trojan-cli.zip
...
function bbr_boost_sh(){
    bash <(curl -L -s -k "https://github.com/cocabox/cocabox/blob/master/newtcp.sh")
}
